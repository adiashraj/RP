...
public class Employee implements Serializable {
	...
	private String internalAssignment;
	...
	public String getInternalAssignment() {
		return internalAssignment;
	}

	public void setInternalAssignment(String internalAssignment) {
	...
	public int getNoOfOpportunity() {
		return noOfOpportunity;
	}

	public void setNoOfOpportunity(int noOfOpportunity) {
